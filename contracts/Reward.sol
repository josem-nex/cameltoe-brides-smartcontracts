...
//         uint256 fundOfTheMonth,
//         uint256 amountPerEth,
...
//             "Only the owner can call this function"
//         ); // Check if the caller has fund manager role.
//         _; // Continue execution.
//     }
...
//     */
//     function addRewardCollectors(
//         address[] memory adds,
//         uint256[] memory prices
//     ) external {
//         require(adds.length == prices.length, "Length is not equal ");
//         require(
//             adds.length == numberOfRewardReceiver,
...
//     */
//     function calculateRewardPerEther(
//         uint256 _funds,
//         uint256 _amountSpend
...
//     */
//     function sendRewards() external payable onlyManager {
//         require(
//             lastRewardTime + 28 days > block.timestamp,
//             "You cannot call this function earlier!"
//         );
//         uint256 fundOfTheMonth = address(this).balance;
//         uint256 amountPerEth = calculateRewardPerEther(
//             fundOfTheMonth,
//             totalSpendingOfTheMonth[index]
//         );
//         for (uint256 i = 0; i < numberOfRewardReceiver; i++) {
//             sendEther(
//                 spendingList[index][i].add,
//                 spendingList[index][i].spendAmount,
//                 amountPerEth
//             );
//         }
